    ...
    methods: {
        getChecked: function getChecked() {
            ...
            return filtered.map(function (item) {
                return __WEBPACK_IMPORTED_MODULE_2__model_dataTransfer_js__["a" /* default */].getAreaNameById(item, that.sep);
            });
        },
        setChecked: function setChecked(areaToAdd) {
            ...
            if (areaList.length > 0) {
                areaList.map(function (item) {
                    nodes = nodes.concat(__WEBPACK_IMPORTED_MODULE_2__model_dataTransfer_js__["a" /* default */].getNodesByName(item, that.sep));
                });
            }
...
/* harmony default export */ __webpack_exports__["a"] = {
    getAreaNameById: function getAreaNameById(id, sep) {
    ...
    getNodesByName: function getNodesByName(name, sep) {
        sep = sep || '-';
        name = name.split(sep);
